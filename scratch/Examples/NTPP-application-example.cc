...
#include "ns3/NTPP-helper.h"
#include "ns3/NTPP-application.h"
...
NS_LOG_COMPONENT_DEFINE ("NTPPApplicationExample");
...
main (int argc, char *argv[])
{
  ...
  cmd.Parse (argc,argv);
  LogComponentEnable ("NTPPApplicationExample", LOG_LEVEL_INFO);
  // LogComponentEnable ("NTPPApplication", LOG_LEVEL_ALL);
  ...
  uint32_t port = 90;
  NTPPHelper ph ("ns3::UdpSocketFactory", InetSocketAddress (interface.GetAddress (1), port));
